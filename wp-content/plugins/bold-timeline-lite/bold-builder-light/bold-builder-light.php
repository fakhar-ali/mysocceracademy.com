	...
	class BTBB_Light {
		...
		function admin_edit_page() {
			...
			<form method="post" action="<?php echo esc_url( add_query_arg( array( 'post' => $post_id ), menu_page_url( $this->slug, false ) ) ); ?>">
				...
				<div class="inside">
				<ul>
				<li><a href="<?php echo esc_url_raw( $this->home_url ); ?>" target="_blank"><?php esc_html_e( 'Home page', 'bold-timeline' ); ?></a></li>
				<?php
				if ( current_user_can( 'activate_plugins' ) && $this->product_id != '' ) { ?>
					<li><a href="<?php echo esc_url_raw( admin_url( 'admin.php?page=' . $this->license_slug ) ); ?>" target="_blank"><?php esc_html_e( 'Product License', 'bold-timeline' ); ?></a></li>
				<?php }
				if ( $this->doc_url != '' ) { ?>
					<li><a href="<?php echo esc_url_raw( $this->doc_url ); ?>" target="_blank"><?php esc_html_e( 'Documentation', 'bold-timeline' ); ?></a></li>
				<?php }
				if ( $this->support_url != '' ) { ?>
					<li><a href="<?php echo esc_url_raw( $this->support_url ); ?>" target="_blank"><?php esc_html_e( 'Support', 'bold-timeline' ); ?></a></li>
				<?php } ?>
				</ul>
				</div>
				</div><!-- #informationdiv -->
